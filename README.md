...
## [ 10월 13일]
1. 객체키와 객체값이 같으면 생략이 가능하다.</br>
2. 한폴더에 전부 넣지말고 컴포넌트를 잘 나눠두는게 편하다.</br>
3. App.js의 getMovies가 state에 저장하고 function Movie로 보내고 이상이 없으면 return으로 html로 디자인을 하고 return이 앱으로 최종랜더링을 한다.</br>
4. 
